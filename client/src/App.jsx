...
const Feed = () => {
  ...
  return (
    <div className="min-h-screen bg-space-deeper p-4 md:p-8">
      <div className="mb-8 flex flex-col gap-4">
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            <h1 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-nebula-purple to-blue-400 mb-2">
              AstroPin
            </h1>
            <p className="text-slate-400 max-w-2xl">Discover and explore NASA's cosmos through pinned imagery, curated into a sleek visual board layout.</p>
          </div>
          <div className="flex flex-wrap gap-2">
            <span className="px-4 py-2 rounded-full bg-white/10 border border-white/10 text-slate-200 text-sm">Trending</span>
            <span className="px-4 py-2 rounded-full bg-white/10 border border-white/10 text-slate-200 text-sm">Space Art</span>
            <span className="px-4 py-2 rounded-full bg-white/10 border border-white/10 text-slate-200 text-sm">NASA Picks</span>
          </div>
        </div>
      </div>
